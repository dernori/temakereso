...
public class Personalization {
    ...
    public List<Email> getTos() {
        if (tos == null) return Collections.<Email>emptyList();
        return tos;
    }
    ...
    public List<Email> getCcs() {
        if (ccs == null) return Collections.<Email>emptyList();
        return ccs;
    }
    ...
    public List<Email> getBccs() {
        if (bccs == null) return Collections.<Email>emptyList();
        return bccs;
    }
    ...
    public Map<String, String> getHeaders() {
        if (headers == null) return Collections.<String, String>emptyMap();
        return headers;
    }
    ...
    public Map<String, String> getSubstitutions() {
        if (substitutions == null) return Collections.<String, String>emptyMap();
    ...
    public Map<String, String> getCustomArgs() {
        if (customArgs == null) return Collections.<String, String>emptyMap();
        return customArgs;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (bccs == null) {
            if (other.bccs != null) return false;
        } else if (!bccs.equals(other.bccs)) {
            return false;
        }
        if (ccs == null) {
            if (other.ccs != null) return false;
        } else if (!ccs.equals(other.ccs)) {
            return false;
        }
        if (customArgs == null) {
            if (other.customArgs != null) return false;
        ...
        if (substitutions == null) {
            if (other.substitutions != null) return false;
